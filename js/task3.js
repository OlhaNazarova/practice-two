...
console.log(storage.addItem("Droid")); // ["Nanitoids", "Prolonger", "Antigravitator", "Droid"]
// storage.removeItem("Prolonger");
console.log(storage.getItems());
console.log(storage.removeItem("Antigravitator")); // ["Nanitoids", "Antigravitator", "Droid"]
console.log(storage.getItems());